...
class AdminAddDelete extends StatefulWidget {
  const AdminAddDelete({super.key});

  @override
  State<AdminAddDelete> createState() => _AdminAddDeleteState();
}

class _AdminAddDeleteState extends State<AdminAddDelete> {
  var height, width;
  @override
